...
<body id="page-top" onload="fnInit();">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="d-sm-flex align-items-center justify-content-between">
                            	<h3 class="m-0 font-weight-bold text-primary">Gateway 목록</h3>
							...
							<div class="table-responsive" id="table" >
                               	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									<tr>
										...
										<th class='centered'><spring:message code="title.pbw.cafeid" /></th>
									</tr>
                                    <tbody id="tablebody">
									<c:forEach var="result" items="${resultList}" varStatus="status">
										<tr id="${result.pbgid}">
											...
											<td class='centered'><a href="javascript:fn_showDetail('<c:out value="${result.pbgid}"/>')"><c:out value="${result.pbgid}"/></a></td>
											...
											<td class='centered'><c:out value="${result.cafeid}"/></td>
										</tr>
									</c:forEach>
									</tbody>
								</table>
	...
	<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
      ...
      <form class="form" role="form" id="form-content" style="display:none" >
        <input type="hidden" class="form-control" id="modalpbgid" name="modalpbgid" placeholder="ID" readonly></input>
        ...
        <div class="form-group">
          <label for="cafeid">매장 ID</label>
          <input type="text" class="form-control" id="cafeid" name="cafeid" ></input>
        </div>
	...
	<script type="text/javascript">
				...
				buttons: [
				  {
					...
					callback: function() {
						$.ajax({
							type: 'POST',
							  url : "/cafemain/updGateway.do",
							data: {
								pbgid : $('#modalpbgid').val(),
								macaddr: $('#macaddr').val(),
								version: $('#version').val(),
								useflag: $('#useflag').val(),
								regflag: $('#regflag').val(),
							  ...
							  success : function(data, textStatus, jqXHR) {
								  if(data.rsltCnt == 1){
									  ...
									  document.location.href="<c:url value='/cafemain/manageGateway.do'/>"
								  }
							  }, 
		...
		function getRowData(id) {
		  ...
		  rowData.cafeid= row.find('td:nth-child(7)').text();
