 ...
 * </pre>
 */
@Mapper("pbgactManageMapper")
public interface PbgactManageMapper {

	public PbgactVO selectPbgact(PbgactVO vo) throws Exception;
	public List<PbgactVO> selectPbgactList(DefaultVO vo) throws Exception;
