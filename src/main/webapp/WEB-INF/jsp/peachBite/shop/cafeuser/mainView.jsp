	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				href="/cafeuser/logout.do">
				<div class="sidebar-brand-icon rotate-n-15">
					<i class="fas fa-laugh-wink"></i>
				</div>
				<div class="sidebar-brand-text mx-3">${userInfo.username}</div>
			</a>
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>customer
						main page</span></a></li>
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<p>SB Admin 2 makes extensive use of Bootstrap 4 utility
										...
										performance. Custom CSS classes are used to create cussom
