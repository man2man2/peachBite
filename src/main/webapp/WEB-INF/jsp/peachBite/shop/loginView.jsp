...
<head>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form:form name="loginForm" method="post" action="#LINK" class="user">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="cfuserid" name="cfuserid" aria-describedby=""
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="/cafemain/loginPage.do">관리자 로그인</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
		...
		function actionLogin() {
			...
			if (document.loginForm.cfuserid.value =="") {
				alert("아이디를 입력하세요");
				return false;
				...
				document.loginForm.action="/cafeuser/mainView.do";
